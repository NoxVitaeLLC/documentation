...
We use this information strictly to link your Discord and VRChat accounts, enabling the bot to assign roles based on your age verification badge. This is the minimum necessary for the bot to work. See our [Privacy Policy](https://noxvitaellc.com/privacy-policy/) and [Terms of Service](https://noxvitaellc.com/terms-of-service/) for full definitions.
...
You may request to remove your data at any time. See the [Privacy Policy](https://noxvitaellc.com/privacy-policy/) for instructions on how to initiate this.

---

## Data Retention

We retain your data only while the bot is active. When the bot is deactivated or upon request, data is deleted securely in compliance with jurisdictional laws.

---

## Data Compliance Standards

We comply with standard data privacy frameworks. See our [Privacy Policy](https://noxvitaellc.com/privacy-policy/) for more details.

---

## COPPA Compliance

**Our services are for users 18+ only.** We do not knowingly store data for minors. If you believe this has occurred, please contact [NoxVitaeofficial@gmail.com](mailto:NoxVitaeofficial@gmail.com).

---

## Related Third-Party Terms
